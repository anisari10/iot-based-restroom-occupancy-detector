...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT `$column_name` FROM Value_table_4";
    ...
    if ($row_count >= $rowCountThreshold) {
        $sqlSum = "SELECT SUM(`$column_name`) AS sum_value FROM Value_table_4";
       ...
       // Delete the column
        $sqlDelete = "DELETE FROM `Value_table_4`";
        ...
        $sql = "INSERT INTO Value_table_4 (`$column_name`) VALUES ('$value')";
